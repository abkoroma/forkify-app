...
/*if (module.hot) {
  module.hot.accept();
    ...
    try {
        ...
        if (!recipeId) return;
        (0, _recipeviewDefault.default).loadSpinner();
        (0, _resultsviewDefault.default).update((0, _model.getSearchResult)());
        (0, _bookmarksviewDefault.default).update((0, _model.state).bookmarks);
        //fetching and loading recipes
        await (0, _model.loadRecipe)(recipeId);
        //rendering recipe
...
async function showSearchResults() {
    try {
        ...
        if (!query) return;
        (0, _resultsviewDefault.default).loadSpinner();
        await (0, _model.loadSearchResults)(query).catch((err)=>(0, _recipeviewDefault.default).errorMessage(err));
        //resultsview.render(state.search.results);
        (0, _resultsviewDefault.default).render((0, _model.getSearchResult)());
...
function controlPagination(goToPage) {
    (0, _resultsviewDefault.default).render((0, _model.getSearchResult)(goToPage));
    (0, _paginationviewDefault.default).render((0, _model.state).search);
}
...
function controlAddBookmark() {
    ...
    else (0, _model.removeBookmark)((0, _model.state).recipe.id);
    //update recipe view
    (0, _recipeviewDefault.default).update((0, _model.state).recipe);
    //render bookmark
...
async function controlAddRecipe(newRecipe) {
    try {
        (0, _addrecipeviewDefault.default).loadSpinner();
        await (0, _model.uploadRecipe)(newRecipe).catch((err)=>{
            (0, _addrecipeviewDefault.default).errorMessage(err);
        });
        (0, _recipeviewDefault.default).render((0, _model.state).recipe);
        (0, _addrecipeviewDefault.default).errorMessage();
        (0, _bookmarksviewDefault.default).render((0, _model.state).bookmarks);
        window.history.pushState(null, "", `#${(0, _model.state).recipe.id}`);
        setTimeout(function() {
            (0, _addrecipeviewDefault.default).toggleWindow();
        }, 2500);
    } catch (err) {
        (0, _addrecipeviewDefault.default).errorMessage(err.message);
    }
}
function init() {
    (0, _bookmarksviewDefault.default).handlerRenderBookmarks(controlBookmarks);
    (0, _recipeviewDefault.default).addEventHandlerRender(showRecipe);
    (0, _recipeviewDefault.default).updateServingsHander(controlServings);
    (0, _recipeviewDefault.default).addEventHandlerBookmark(controlAddBookmark);
    (0, _searchviewDefault.default).addEventHandlerSearch(showSearchResults);
    (0, _paginationviewDefault.default).paginationClickHandler(controlPagination);
    (0, _addrecipeviewDefault.default).handlerUplaodRecipe(controlAddRecipe);
}
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model":"Y4A21","./views/recipeview":"8Jlc1","./views/searchview":"furg1","./views/resultsview":"4wEfE","./views/paginationview":"ixwX5","./views/bookmarksview":"kkwkM","./views/addrecipeview":"iwHYz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
async function loadRecipe(recipeId) {
    try {
        const recipeData = await (0, _helpers.reqJSON)(`${(0, _config.API_URL)}${recipeId}?key=${(0, _config.API_KEY)}`);
...
async function loadSearchResults(query) {
    try {
        ...
        const searchData = await (0, _helpers.reqJSON)(`${(0, _config.API_URL)}?search=${query}&key=${(0, _config.API_KEY)}`).catch((err)=>{
            throw err;
        });
...
async function uploadRecipe(newRecipe) {
    try {
        ...
        const recipesData = await reqJSONJSON(`${(0, _config.API_URL)}?key=${(0, _config.API_KEY)}`, recipe);
...
const API_KEY = "a152eada-d10e-4e2f-b125-1ba3de141a5e";
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "reqJSON", ()=>reqJSON);
parcelHelpers.export(exports, "timeout", ()=>timeout);
async function reqJSON(url, uploadData) {
    try {
...
const [icons] = (0, _iconsSvgDefault.default).split("?");
        ...
        return `
            <li class="recipe__ingredient">
                ...
                <div class="recipe__quantity">
                    ${ingredient.quantity ? (0, _fractyDefault.default)(ingredient.quantity).toString() : ""}
                </div>
...
},{"./view":"bWlJ9","../../img/icons.svg":"cMpiy","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bWlJ9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class View {
    ...
    update(data) {
        ...
        newElements.forEach((newEle, i)=>{
            ...
            if (!newEle.isEqualNode(currEle) && newEle.firstChild?.nodeValue.trim() !== "") currEle.textContent = newEle.textContent;
            if (!newEle.isEqualNode(currEle)) Array.from(newEle.attributes).forEach((attr)=>currEle.setAttribute(attr.name, attr.value));
        });
    }
    _clear() {
...
},{"./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4wEfE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"bWlJ9","./previewview":"40MDS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"40MDS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"bWlJ9","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kkwkM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"bWlJ9","./previewview":"40MDS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iwHYz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f0HGD","aenu9"], "aenu9", "parcelRequire3a11")
